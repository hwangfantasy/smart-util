 ...
 * @author Cheng Li
 * 
 * @version $Id: Money.java 3488 2011-09-21 02:28:49Z qingming $
 */
public class Money implements Serializable, Comparable {
	 ...
	 */
	protected static Map CURRENCY_DISPLAY_UNIT_MAP = new HashMap();
	// 进行初始化工作
	static {
		// 簡體中文的對應錶
		Map zhCNMap = new HashMap();
		zhCNMap.put("CNY", "元");
		zhCNMap.put("POINT", "积分");
		CURRENCY_DISPLAY_UNIT_MAP.put("zh_CN", zhCNMap);

		// 繁體的對應錶
		Map zhHKMap = new HashMap();
		zhHKMap.put("CNY", "元");
	...
	public String fenToYuanString(long fen) {
		...
		return BigDecimal.valueOf(fen, currency.getDefaultFractionDigits()).toString();
	}
