package com.hwangfantasy.smartutil.money;
...
public class MoneyUtil {
	...
	public static int convertToCentReturnInt(String yuan) {
		return new Long(convertToCent(yuan)).intValue();
	}

	public static int convertToCentReturnInt(double yuan) {
		return new Long(convertToCent(yuan)).intValue();
	}
	 ...
	 * @return
	 */
	public static String convertToYuanStringWithFormat(Long cent) {
		if (cent == null)
			return null;
		if (cent.equals(0)) {
			return "0.00";
		...
		BigDecimal b = new BigDecimal(cent).movePointLeft(2);
		return beforeStr + moneyformat.format(b.doubleValue());
	}

	public static void main(String[] args) {
		System.out.println(MoneyUtil.convertToYuanStringWithFormat(-1l));
	}
}
